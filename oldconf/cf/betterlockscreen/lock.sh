...
lock() {
	...
	i3lock \
		...
		--ringvercolor=$foreground --ringwrongcolor=$foreground --indpos="x+580:h-400" \
		--radius=80 --ring-width=10 --veriftext="Ilyase" --wrongtext="sir b7alek" \
